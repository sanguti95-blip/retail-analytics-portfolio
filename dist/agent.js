...
function initAgent() {
    ...
    function updateStatus() {
        // Al estar la clave delegada en el servidor, el agente siempre está disponible
        statusText.innerHTML = `<i class="fa-solid fa-circle-check" style="color: var(--success);"></i> Agente activo — Groq Cloud (llama-3.3-70b)`;
        ...
        if (btnConfig) {
            btnConfig.style.display = 'none'; // Ocultar botón de configuración ya que se maneja seguro en backend
        }
    }
